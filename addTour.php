...
<form class="container" id="needs-validation" method="POST" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-6 mb-3">
				<label for="validationCustom01">Tour Title</label>
				<input type="text" class="form-control" id="validationCustom01" placeholder="Enter Tour Name" name="name"  required>
			</div>
			<div class="col-md-6 mb-3">
				...
				<select class="form-control" name="category" required>
                    ...
                    <option value="Gorilla Permit">Gorilla Permit</option>
		...
		<div class="row">
			<div class="col-md-6 mb-3">
				...
				<input type="text" class="form-control" id="validationCustom03" placeholder="Enter Price" name="price" required>
			</div>
			<div class="col-md-6 mb-3">
				<label for="validationCustom04">Image 1</label>
		...
		<div class="row">
			<div class="col-md-4 mb-3">
				<label for="validationCustom04">Image 2</label>
				<input type="file" id="file2" class="form-control" name="image2">
			</div>
			<div class="col-md-4 mb-3">
				<label for="validationCustom04">Image 3</label>
