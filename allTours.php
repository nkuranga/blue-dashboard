...
$show  = "SELECT id,name,category,image1,LEFT(description,120),price FROM tour WHERE status='Active' ORDER BY dateInserted DESC LIMIT $starting_limit, $limit";
...
<img class="card-img-top img-fluid" src="../images/<?php echo $row["image1"];?>" alt="<?php echo $row['name'];?>" style="height: 200px;">
<div class="card-body">
    ...
    <p><a href="editTour.php?id=<?php echo $row['id'];?>"><button class="btn btn-success"><i class="fa fa-edit"></i>   Edit</button></a>&nbsp;&nbsp;
        <a href="delete-tour?id=<?php echo $row['id']?>" title="click for delete"onclick="return confirm('Sure to delete this record?')">
