...
<div class="row">
    ...
    $result = $db->prepare("SELECT * FROM aboutus WHERE id= :id");
...
<div class="card-body">
<form class="container" id="needs-validation" method="POST" action="updateAbout?id=<?php echo $row['id'];?>">		
		<div class="row">	
			<div class="col-md-12">
				<label for="validationCustom04">About us Content</label>
				<input type="tex" name="id" value="<?php echo $row['id'];?>" hidden>
				<textarea class="form-control" name="description" rows="5" id="editor1"><?php echo $row['description'];?></textarea><br>
