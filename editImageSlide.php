...
<div class="row">
    ...
    $result = $db->prepare("SELECT * FROM slide WHERE id= :id");
...
<div class="card-body">
<form class="container" id="needs-validation" method="POST" action="updateImageSlide?id=<?php echo $row['id'];?>" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12 mb-3">
				...
				<label for="validationCustom03">Choose Image</label><br>
