...
<div class="row">
    ...
    $result = $db->prepare("SELECT * FROM tour WHERE id= :id");
...
<div class="card-body">
<form class="container" id="needs-validation" method="POST" action="updateTour.php?id=<?php echo $row['id'];?>">
		<div class="row">
			<div class="col-md-6 mb-3">
				<label for="validationCustom01">Tour Title</label>
				<input type="text" class="form-control" id="validationCustom01" name="name" value="<?php echo $row['name'];?>">
		...
		<div class="row">
			<div class="col-md-12 mb-3">
				...
				<input type="text" class="form-control" id="validationCustom03" placeholder="Enter Price" name="price" value="<?php echo $row['price'];?>">
			</div>
